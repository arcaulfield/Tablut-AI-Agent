...
//
// Note: The script is currently set up to have the MonteCarloPlayer play against
...
// to test. For example to have MonteCarloPlayer play against itself, you would
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            ProcessBuilder client1_pb = new ProcessBuilder("java", "-cp", "bin", "-Xms520m", "-Xmx520m",
                    "boardgame.Client", "monte_carlo_player.MonteCarloPlayer");
